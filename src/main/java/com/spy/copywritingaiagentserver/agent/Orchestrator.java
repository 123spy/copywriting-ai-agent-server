...
import com.spy.copywritingaiagentserver.agent.agent.*;
...
import com.spy.copywritingaiagentserver.agent.service.ImageGenerationService;
...
public class Orchestrator {
    ...
    public FinalPostResult generate(UserRequirement userRequirement) {
        try {
            ...
            // 7. 局部修正闭环
            int retry = 0;
            while (!reviewResult.isPass() && retry < MAX_RETRY) {
