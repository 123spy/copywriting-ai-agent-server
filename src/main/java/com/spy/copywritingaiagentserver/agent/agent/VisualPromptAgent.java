...
@Component
public class VisualPromptAgent {

    private final ChatClient chatClient;
    private final KnowledgeRetrievalService knowledgeRetrievalService;

    public VisualPromptAgent(ChatModel chatModel, KnowledgeRetrievalService knowledgeRetrievalService) {
    ...
    public VisualPromptResult execute(
        ...
        VisualPromptResult visualPromptResult = chatClient
                .prompt()
